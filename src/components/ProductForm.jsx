...
const ProductForm = (props) => {
  ...
  const dialogFooter = (
    <div className="ui-dialog-buttonpane p-clearfix">
      <Button label="Eliminar" style={{ backgroundColor: "red" }} icon="pi pi-times" onClick={_deleteProduct} />
      <Button label="Guardar" style={{ backgroundColor: "green" }} icon="pi pi-check" onClick={saveProduct} />
    </div>
  );
